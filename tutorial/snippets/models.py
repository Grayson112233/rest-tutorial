...
# Django CharField.choices requires a list of tuples
# in the format (stored_value, displayed_value)
...
class Snippet(models.Model):
    ...
    language = models.CharField(choices=LANGUAGE_CHOICES, default='python',
                                max_length=100)
    style = models.CharField(choices=STYLE_CHOICES, default='native',
                             max_length=100)
